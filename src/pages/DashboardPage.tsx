...
export function DashboardPage() {
  ...
  const handleAnalyzeImage = async (image: string) => {
    ...
    try {
       ...
       * It is sent directly to the Edge Function.
       */
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-primary-50 mt-2 max-w-xl">
              Upload a medical report and let MedFluent
...
function StatCard({
  ...
  return (
    <div className="card p-4">
      <div
        className={`w-9 h-9 rounded-lg ${colors[color]} flex items-center justify-center mb-2`}
      >
